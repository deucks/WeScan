...
final class ScannerViewController: UIViewController {
    ...
    private func setupConstraints() {
        ...
        if #available(iOS 11.0, *) {
            ...
            let shutterButtonBottomConstraint = view.safeAreaLayoutGuide.bottomAnchor.constraint(equalTo: shutterButton.bottomAnchor, constant: 170.0)
            ...
            let shutterButtonBottomConstraint = view.bottomAnchor.constraint(equalTo: shutterButton.bottomAnchor, constant: 170.0)
            shutterButtonConstraints.append(shutterButtonBottomConstraint)
        }
